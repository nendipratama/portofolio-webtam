      ...
      items: [
        {
          ...
          github: 'https://github.com/nendipratama',
          demo: 'https://portofoliowebtam.web.app/'
        },
        {
          id: 2,
          name: 'KANBAN APP',
          imageUrl: 'kanbanapp',
          status: 'This website application works like tracking an activity',
          tech: 'Javascript',
          github: 'https://github.com/nendipratama',
          demo: 'https://github.com/nendipratama/kanban-app'
        },
        {
          id: 3,
          name: 'FIBONACCI',
          imageUrl: 'fibonacci',
          status: 'Fibonacci is a sequence of numbers where each number is the sum of the two preceding ones, starting from 0 and 1. Enter a number to get the Fibonacci sequence up to that number.',
          tech: 'Javascript, CSS',
          github: 'https://github.com/nendipratama/Fibonacci-calculator',
          demo: 'https://pratama-fibonacci-app.netlify.app/'
        },
        {
          id: 3,
          name: 'PLANNER APP',
          imageUrl: 'plannerapp',
          status: 'Fibonacci is a sequence of numbers where each number is the sum of the two preceding ones, starting from 0 and 1. Enter a number to get the Fibonacci sequence up to that number.This application contains widgets such as time, calendar, etc.',
          tech: 'Javascript',
          github: 'https://github.com/nendipratama/planner-app',
          demo: 'https://pratama-planner-app.web.app/'
        },
      ]
    };
  }
